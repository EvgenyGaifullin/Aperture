...
/* Функция PopupWithForm отвечает за отображение и управление формой заказа всплывающего окна на сайте. 
Она содержит состояния всех полей формы (имя, телефон, цвет и т.д.), 
а также методы для изменения этих состояний при вводе пользователем данных. */
